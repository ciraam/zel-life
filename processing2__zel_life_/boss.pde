class Boss {
  ...
  Boss(String nom, int life, int atk, float posX, float posY, PImage img){
    this.nom = nom;
    this.life = life;
    this.atk = atk;
    this.posX = posX;
         ...
         //  println(chiffre);
           switch(chiffre) {
              case 1:
                if (testColision5(int(this.posX - this.speed), int(this.posY)) == 0){ 
                   this.posX -= this.speed;  // gauche
                   this.img = loadImage("../image/boss2Gauche.png");
                   if (testColision5(int(myBoss.posX - myBoss.speed), int(this.posY)) == 2){ 
                    // println("dégât1");
                     lifePersonnage = lifePersonnage - this.atk;
                     myPersonnage.img = loadImage("../image/persoDegat.png");
              ...
              case 2: 
                if (testColision5(int(this.posX + this.speed), int(this.posY)) == 0){ 
                   this.posX +=  this.speed; // droite
                   this.img = loadImage("../image/boss2.png");
                   if (testColision5(int(this.posX + this.speed), int(this.posY)) == 2){ 
                    // println("dégât2");
                     lifePersonnage = lifePersonnage - this.atk;
                     myPersonnage.img = loadImage("../image/persoDegat.png");
  ...
  void afficherNomVie2() {
      fill(#FA4CE3);
      textSize(13);
      text(this.life + "/300", this.posX + 50, this.posY);
